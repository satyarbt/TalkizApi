...
public class UpdateBankDetails extends BaseTest{
	
	@Test(priority = 2, description = "Verify UpdateBankDetails API StatusCode, Response Time and Nodes", groups= {"UserExisting"})
